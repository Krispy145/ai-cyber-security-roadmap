...
| [`flutter-ai-chat-rag`](https://github.com/Krispy145/flutter-ai-chat-rag) | Flutter RAG chat with streaming UI (Riverpod + GetIt), connects to Secure AI API. | flutter, rag, riverpod, dio | 🧩 Scaffolded | 19/04/2027 |
| [`flutter-iam-package`](https://github.com/Krispy145/flutter-iam-package) | Flutter OIDC/OAuth2 package: login, token refresh, Dio interceptors. | flutter, oidc, oauth2, jwt | 🧩 Scaffolded | 22/02/2027 |
| [`flutter-api-showcase`](https://github.com/Krispy145/flutter-api-showcase) | Flutter API client patterns: BLoC, Dio, pagination, caching; integrates flutter-iam-package. | flutter, bloc, dio, pagination | 🧩 Scaffolded | 14/06/2027 |
...
| Login + secure storage | React Native | 19/04/2027 | ⏳ Planned |
| RAG chat screen (/rag/query) | React Native | 10/05/2027 | ⏳ Planned |
| Streaming chat (SSE/WS) | React Native | 31/05/2027 | ⏳ Planned |
| Scaffold repo | React Native | 26/10/2025 | ✅ Done |
| Samples list (/phishing/samples) | React Native | 14/06/2027 | ⏳ Planned |
